    ...
    return (
        <UserContext.Provider value={user}>
            ...
            <div className="profile-container">
                ...
                <div className="tabs">
                    <button className="tab" onClick={() => setActiveTab('cp')}>CP</button>
                    <button className="tab" onClick={() => setActiveTab('academic')}>Academic</button>
                    <button className="tab" onClick={() => setActiveTab('socials')}>Socials</button>
                </div>
...
function CP() {
    const {user,codeforcesHandle} = useContext(UserContext);
    return (<div className="cp-section">
        {codeforcesHandle &&  <div className="platform">Codeforces Handle: {codeforcesHandle};</div>}
...
function Academic() {
    ...
    return <div className="academic-section">
