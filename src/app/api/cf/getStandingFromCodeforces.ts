 ...
 * @param handles An array of Codeforces handles.
 * @param apiKey Codeforces API key.
 * @param apiSecret Codeforces API secret.
 * @returns A Promise that resolves to a tuple containing the standing record and number of problems,
 *          or null on failure.
 */
 ...
 * @param apiKey Codeforces API key.
 * @param apiSecret Codeforces API secret.
 * @returns A Promise resolving to an array of rows or null if fetching fails.
 */
 ...
 * @param apiKey Codeforces API key.
 * @param apiSecret Codeforces API secret.
 * @returns A Promise that resolves to an array of all standing rows.
 */
